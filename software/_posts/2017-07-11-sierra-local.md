...
title: sierra-local
year: 2017
authors: ArtPoon, jzpero, gtng92, GopiGugan, MathiasRenaud, WilliamZekaiWang, SandeepThokala
github: https://github.com/PoonLab/sierra-local
license: License(name="GNU General Public License v3.0")
description: "Retrieve HIVdb algorithm as XML and apply locally to HIV sequences"
forks: 3
stars: 6
